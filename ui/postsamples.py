...
class Ui_PostSamples_DockWidget(object):
    ...
    def retranslateUi(self, PostSamples_DockWidget):
        ...
        self.boundary_comboBox.setItemText(1, _translate("PostSamples_DockWidget", "Word Map Extent", None))
        self.boundary_comboBox.setItemText(2, _translate("PostSamples_DockWidget", "None", None))
