...
class Ui_PostSamples_DockWidget(object):
    def setupUi(self, PostSamples_DockWidget):
        ...
        self.copySQL_pushButton = QtGui.QPushButton(self.dockWidgetContents)
        self.copySQL_pushButton.setObjectName(_fromUtf8("copySQL_pushButton"))
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.copySQL_pushButton)
    ...
    def retranslateUi(self, PostSamples_DockWidget):
        ...
        self.label_2.setText(_translate("PostSamples_DockWidget", "Max Results ", None))
        self.search_pushButton.setText(_translate("PostSamples_DockWidget", "Search", None))
        self.copySQL_pushButton.setText(_translate("PostSamples_DockWidget", "Copy SQL to Clipboard", None))
