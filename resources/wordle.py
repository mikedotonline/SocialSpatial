...
logging.basicConfig(level=logging.INFO) # optional argument filename='example.log'
...
class Shp_WordCloud(object):
	...
	def generate(self, width, height):
		...
		#for i in range(0,k):
			...
			logging.debug("shape of Z:"+str(Z.shape)+ "shape of mask:"+str(mask.shape))	
			Z+=mask
